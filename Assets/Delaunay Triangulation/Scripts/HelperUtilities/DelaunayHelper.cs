...
public static class DelaunayHelper
{
    ...
    /// <summary> Returns a set of bounds enclosing a point set </summary>
    ...
    /// <summary> Triangulates a set of points utilising the Bowyer Watson algorithm </summary>
    public static List<Triangle> Delaun(List<Point> points)
    {
        ...
        for (int pIndex = 0; pIndex < points.Count; pIndex++)
        {
            ...
            for (int triIndex = triangles.Count - 1; triIndex >= 0; triIndex--)
            {
                ...
                //A 'bad triangle' is defined as a triangle who's CircumCentre contains the currentTexture point
